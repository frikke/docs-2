...
**Note:** this is the "per-architecture" repository for the `i386` builds of [the `postfixadmin` official image](https://hub.docker.com/_/postfixadmin) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
[![i386/postfixadmin build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/i386/job/postfixadmin.svg?label=i386/postfixadmin%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/postfixadmin/)
...
The `i386/postfixadmin` images come in many flavors, each designed for a specific use case.

## `i386/postfixadmin:<version>`
