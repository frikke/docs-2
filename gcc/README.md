...
[![s390x/gcc build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/gcc.svg?label=s390x/gcc%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/gcc/)
