...
-	[`latest`, `base`](https://github.com/clearlinux/docker-brew-clearlinux/blob/a180d1a2ebd692b5c5403e698f48c98f5a1df5ce/Dockerfile)

[![amd64/clearlinux build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/amd64/job/clearlinux.svg?label=amd64/clearlinux%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/clearlinux/)
...
The `amd64/clearlinux:latest` tag will point to `amd64/clearlinux:base` which will track toward the latest release version of the distribution.
