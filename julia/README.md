...
[![ppc64le/julia build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/julia.svg?label=ppc64le/julia%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/julia/)
...
```console
$ docker run -it --rm ppc64le/julia
```

## Run Julia script from your local directory inside container

```console
$ docker run -it --rm -v "$PWD":/usr/myapp -w /usr/myapp ppc64le/julia julia script.jl arg1 arg2
```
